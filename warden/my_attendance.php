...
<div class="container mt-4">
    <h3 class="mb-2" style="font-weight:700; ">📊 My Attendance</h3>
                    ...
                    <?php foreach($attendance as $row): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="attendance_correction.php?date=<?= urlencode($row['date']) ?>&current=<?= urlencode($row['status']) ?>" class="btn btn-outline-primary btn-sm">Request Correction</a>
                                <?php else: ?>
