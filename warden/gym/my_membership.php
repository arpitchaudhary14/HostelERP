    ...
    <div class="row g-4">
        <div class="col-md-5 reveal">
            <div class="glass-card-light h-100">
                <h4 class="mb-4 fw-bold">My MatrixFit Status</h4>
                <?php if($active_sub){ ?>
                    <div class="text-center py-4">
                        ...
                        <p class="text-muted">ID: #MF-W-<?= $active_sub['id'] ?></p>          
                ...
                <?php } else { ?>
                    <div class="text-center py-5">
                        ...
                        <h5 class="mt-3">No Membership Found</h5>
                        <p class="text-muted small">You don't have an active gym plan.</p>
                        <a href="plans.php" class="btn btn-gradient mt-2">Browse Plans</a>
                    </div>
                <?php } ?>
            </div>
        </div>
        <div class="col-md-7 reveal">
            <div class="glass-card-light h-100">
                <h4 class="mb-4 fw-bold">My Subscription History</h4>
